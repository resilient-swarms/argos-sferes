...
CCoverageBehavior::CCoverageBehavior(Real m_fRangeAndBearing_RangeThreshold) :
...
bool CCoverageBehavior::TakeControl()
{
...
void CCoverageBehavior::Action(Real &fLeftWheelSpeed, Real &fRightWheelSpeed)
{
...
void CCoverageBehavior::PrintBehaviorIdentity()
{
    std::cout << "Coverage taking over";
}
