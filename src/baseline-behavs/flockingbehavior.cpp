...
{
    /************************************************************************************/
    m_fEstimated_Velocity_ShortTimeWindow = CVector2(-10000.0f, -10000.0f);
    m_fEstimated_Velocity_MediumTimeWindow = CVector2(-10000.0f, -10000.0f);
...
void CFlockingBehavior::SimulationStep()
{
    ...
    /*
    But when do we delete the observed robot from the list of observed robots; perhaps if it has not been observed for a long time.
    */
    t_ListObservedRobots::iterator it_listobrob = m_pcListObservedRobots.begin();
