...
num_fault_types = {"decentralised": 1, "centralised": 9}
foraging_perturbations = {"decentralised": foodscarcity_perturbations,
                          "centralised":proximity_sensor_perturbations + ground_sensor_perturbations +
                                        actuator_perturbations + software_perturbations +
                                        softwarefood_perturbations + foodscarcity_perturbations + agent_perturbations}#+ agent_perturbations


foraging_fault_types = {"decentralised":["Food-Scarcity"],
                        "centralised":["Proximity-Sensor","Ground-Sensor","Actuator","Software-Nest","Software-Food","Food-Scarcity","Agents"]}
...
def get_fault_type(fault,centralised):
    if centralised=="decentralised":
        if fault.startswith("food_scarcityp"):
            return "Food-Scarcity",0
        else:
