...
foraging_perturbations = foodscarcity_perturbations  #+ agent_perturbations


num_fault_types= 1

foraging_fault_types=["Food-Scarcity"] #["Proximity-Sensor","Ground-Sensor","Actuator"]#,"Software-Food"]#,"Food-Scarcity","3-agents",
                     # "12-agents","24-agents"]
