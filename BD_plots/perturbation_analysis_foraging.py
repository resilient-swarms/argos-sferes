...
num_sensorfaults=30
num_actuatorfaults=20
num_agents=6
sensorfaults = ["sensorp"+str(i) for i in range(num_sensorfaults)]
actuatorfaults = ["actuatorp"+str(i) for i in range(num_actuatorfaults)]
agentfaults = ["agentsp"+str(i) for i in range(num_agents*2)]
softwarefaults = ["softwarep"+str(i) for i in range(num_agents)]
