...
def get_combined_archive(BD_directory,runs, archive_file_path,by_bin=True):
    if by_bin:
        combined_archive={}
    else:
        combined_archive=[]
...
if __name__ == "__main__":
    #bins=get_bins(2, 3)
    #p=get_archives_performances("/home/david/argos-sferes/experiments/data/MeanSpeed/history",5,"archive_900.dat")
